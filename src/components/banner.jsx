                ...
                <div className="row align-items-center g-0">
                    <div className="col-lg-6">
                        <div className="content">
                            <span className="banner-top-title">Advanced Technology</span>
                            <h1><span className="grd-color-1" >AI Solutions</span> for Modern Business.</h1>
                            <p>Enhance your business with cutting-edge artificial intelligence technology designed for efficiency, innovation, and growth.</p>
