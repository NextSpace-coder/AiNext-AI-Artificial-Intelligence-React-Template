          ...
          <div className="row">
            <div className="col-lg-4 col-md-6 col-sm-6">
              <div className="single-footer-widget">
                ...
                <p>Advanced technology solutions for modern businesses. Empowering growth through innovative AI and digital services.</p>
            ...
            <div className="col-lg-4 col-md-6 col-sm-6">
              <div className="single-footer-widget">
                ...
                <div className="footer-newsletter-info">
                  <p>Join numerous clients getting our updates about the latest technology trends and solutions.</p>
